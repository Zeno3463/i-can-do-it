...
const About = () => {
	return (
		<div className='p-10 m-10 rounded-3xl shadow-2xl'>
			<h1 className='font-bold text-4xl p-5'><span className='text-7xl'>"</span>All motivational and inspiring contents from the internet gathered in one place."</h1>
